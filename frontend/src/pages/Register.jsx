                ...
                <div className="w-full max-w-2xl">
                    <header className="text-center mb-10">
                        ...
                        <p className="text-gray-500 mt-2 font-medium italic">
                            Tu proxima gran lectura comienza con un voto.
                        </p>
                    </header>
                    ...
                    <form onSubmit={handleSubmit(registerUser)} className="space-y-6 bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
                        ...
                        <div>
                            ...
                            <textarea
                                rows="4"
                                placeholder="Cuéntanos un poco sobre ti como lector o autor"
                                className="block w-full rounded-lg border border-gray-200 bg-white py-2.5 px-3 text-sm text-gray-700 focus:border-[#e67e22] focus:ring-1 focus:ring-[#e67e22] focus:outline-none transition-all duration-200 shadow-sm"
                                {...register("biografia")}
                            />
                        </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <select className={inputStyle} {...register("provincia", { required: "Selecciona tu provincia" })}>
                                        <option value="">Desde donde nos lees?</option>
                                    ...
                                    <input type="date" className={inputStyle}
                                        {...register("fechaNacimiento", {
                                            ...
                                            validate: (value) => {
                                                ...
                                                return age >= 13 || "Debes tener al menos 13 anos"
                                            }
                                        })}
                                    />
                                </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                            ...
                            <div>
                                <label className={labelStyle}>Correo electronico</label>
                                <div className="relative">
                        ...
                        <div>
                            <label className={labelStyle}>Contrasena de acceso</label>
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    {...register("password", { required: "Define una contrasena", minLength: {value: 6, message: "Minimo 6 caracteres"} })}
                                />
                                <button
                                    type="button"
                    ...
                    <div className="mt-8 text-center">
                        <p className="text-gray-500 text-sm">Ya eres parte del club?</p>
            ...
            <div className="hidden lg:block lg:w-5/12 relative">
                ...
                <div className="absolute inset-0 flex flex-col justify-center p-12 z-20 text-white">
                    ...
                    <p className="text-xl mt-6 font-light italic max-w-md drop-shadow-lg">
                        La lectura es una conversacion. Todos los clubes de lectura tienen un final, pero la amistad que surge de ellos es para siempre.
                    </p>
                </div>
            </div>
        </div>
